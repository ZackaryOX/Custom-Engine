...
bool Engine::startUp()
{
	...
	tilesCenterVector.push_back(&tilesCenterColor);
	tilesCenterVector.push_back(&tilesCenterRough);
	tilesCenterVector.push_back(&tilesCenterMetal);
	tilesCenterVector.push_back(&tilesCenterAO);
	tilesCenterVector.push_back(&tilesCenterNormal);
	...
	River = Object(&riverMesh, riverVector, glm::scale(objectTransform, glm::vec3(0.915)), &testMat); //glm::scale(objectTransform, glm::vec3(8.0f, 0.0f, 8.0)
	...
	Playertwo = Player(&testmesh2, &playerColor, Player2Transform, &testMat, 100, 1.0f, &Aim2);
	...
	//MERGE 2 START
	tempability = Ability(&Playerone, 2.0f, 12.0f);
	tempability2 = Ability(&Playertwo, 2.0f, 12.0f);
	playoneskillshot = Skillshot(&Playerone, 3.0f, 25.0f, 1.6f, 5.0f, 0.8f, &Spear1);
	playtwoskillshot = Skillshot(&Playertwo, 3.0f, 25.0f, 1.6f, 5.0f, 0.8f, &Spear2);

	playoneskillshot2 = Skillshot(&Playerone, 6.0f, 30.0f, 1.0f, 5.0f, 0.8f, &SecondSpear1);
	playtwoskillshot2 = Skillshot(&Playertwo, 6.0f, 30.0f, 1.0f, 5.0f, 0.8f, &SecondSpear2);
	//MERGE 2 END
